...
public enum SuccessCode {
    ...
    CREATE_ORDER_SUCCESS(200, HttpStatus.CREATED, "주문이 정상적으로 처리되었습니다."),
    ADD_ITEM_TO_CART_SUCCESS(200, HttpStatus.OK, "장바구니에 메뉴와 수량이 정상적으로 들어갔습니다."),
    ORDER_STATUS_CHANGED(200, HttpStatus.OK, "주문 상태가 정상적으로 변경되었습니다."),
    ORDER_REJECTED(200, HttpStatus.OK, "주문이 정상적으로 거절 상태로 변경되었습니다."),
