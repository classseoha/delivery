...
public enum SuccessCode {
    ...
    CREATE_SUCCESS(201, HttpStatus.CREATED,"가게를 오픈하였습니다."),
    ...
    //주문
    CREATE_ORDER_SUCCESS(201, HttpStatus.CREATED, "주문을 완료하였습니다."),
    ADD_ITEM_TO_CART_SUCCESS(201, HttpStatus.CREATED, "장바구니에 메뉴와 수량이 정상적으로 들어갔습니다."),
    ...
    //메뉴
    CREATE_MENU_SUCCESS(201, HttpStatus.CREATED,"메뉴를 생성 하였습니다."),
